...
png(file="figure3.png",width=1500,height=1000) #to store in png
par(mfrow=c(2,1))
par(mar = c(5, 7,4, 2)) ## setting for legend function
#plot2 more experts
y5 <- dsnorm(x,.8,2,1)
y6 <- dsnorm(x,.5,.6,1)
y7 <- dsnorm(x,3,4.5,1)
y8 <- dsnorm(x,4.5,.75,1)
plot(x,y1,type="l",col="red",lwd=3,xlab=expression(theta),ylab= "density",
     ylim=c(0,.7),cex.lab=2.5, cex.axis=2)
#axis(side=1,at=0,labels=0)
lines(x,y5,type="l",col="blue",lwd=3,lty=1)
lines(x,y6,type="l",col="blue",lwd=3,lty=2)
lines(x,y7,type="l",col="blue",lwd=3,lty=3)
lines(x,y8,type="l",col="blue",lwd=3,lty=4)
...
legend("topright",bty="n",lty=c(1,1,2,3,4),lwd=c(3,3,3,3,3),col=c("red","blue","blue","blue","blue"),
       legend=c("Data","Expert 1", "Expert 2","Expert 3","Expert 4"),cex=2.5)
#add legend
...
lines(x,y9,type="l",col="blue",lwd=3)
lines(x,y10,type="l",col="blue",lwd=3)
lines(x,y11,type="l",col="blue",lwd=3)
lines(x,y12,type="l",col="blue",lwd=3)
lines(x,y13,type="l",col="blue",lwd=3)
lines(x,y14,type="l",col="blue",lwd=3)
...
legend("topright",bty="n",lty=c(1,1),lwd=c(3,3),col=c("red","blue"),legend=c("Data","Expert 1-6"),cex=2.5)
#add legend
